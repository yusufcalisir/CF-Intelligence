...
1. Frontend Suite (Vitest: 81 test files, 315 integration/view/component/E2E tests)
2. Frontend Visual & A11y Suite (Playwright: 72 tests across viewports, responsive & axe-core)
3. Backend Suite (Pytest: 2518 unit, integration, chaos, and property-based tests)
