...
* [`services/flower_p2p_engine.py`](../backend/app/application/services/flower_p2p_engine.py): Serverless peer-to-peer federated learning rounds with Ring and Mesh gossip strategies (`P2PGossipStrategy`).
