...
All controls listed above are automatically verified by the continuous testing pipeline across **2,856 automated tests** (2,514 Backend Pytest + 311 Frontend Vitest + 31 Smart Contracts) and 18 scientific verification audit modules (307 verification tests; 3,163 total).
