...
All controls listed above are automatically verified by the continuous testing pipeline across **2,743 automated tests** (2,444 Backend Pytest + 268 Frontend Vitest + 31 Smart Contracts) and 18 scientific verification audit modules (307 verification tests; 3,050 total).
