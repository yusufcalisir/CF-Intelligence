...
| **CC6.6** | Perimeter Defense | Perimeter WAF Protection & Attack Payload Rejection | Edge gateway is protected by [PerimeterWAFGuard](../../backend/app/infrastructure/security/perimeter_waf.py), enforcing IP whitelisting, brute-force lockout (5 failures / 300s), sensitive path blocking, and rejection of SQL injection, XSS, and null-byte payloads. | [perimeter_waf.py](../../backend/app/infrastructure/security/perimeter_waf.py) | [test_sql_injection_rejected()](../../backend/tests/unit/test_security_controls_audit.py)<br>[test_env_file_not_exposed()](../../backend/tests/unit/test_security_controls_audit.py)<br>[test_auth_lockout_after_5_failures()](../../backend/tests/unit/test_security_controls_audit.py) | `PASS` |
