...
[![Passing Tests](https://img.shields.io/badge/tests-2543%2F2543_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,236 / 2,236 passing (2,543 total incl. verification)** | 100% | 1,943 Backend Pytest + 262 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,236 Tests Core / 2,543 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (1,943 tests)
