...
[![Passing Tests](https://img.shields.io/badge/tests-3189%2F3189_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,882 / 2,882 passing (3,189 total incl. verification)** | 100% | 2,528 Backend Pytest + 323 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,882 Tests Core / 3,189 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (2,528 tests)
pytest backend/tests/ -v

# 2. Run Interactive POC Sandbox Replay CLI evaluation
python benchmark.py --poc-replay

# 3. Run full frontend vitest suite (323 tests across 81 test files)
