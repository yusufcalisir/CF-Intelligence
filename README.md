...
[![Passing Tests](https://img.shields.io/badge/tests-3159%2F3159_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
│   │
│   └── tests/                                       # Vitest & React Testing Library Suite (307 Tests across 81 Files)
│
...
| **Full Test Suite Pass Rate** | **2,852 / 2,852 passing (3,159 total incl. verification)** | 100% | 2,514 Backend Pytest + 307 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
# 3. Run full frontend vitest suite (307 tests across 81 test files)
