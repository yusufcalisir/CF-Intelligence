...
[![Passing Tests](https://img.shields.io/badge/tests-1699%2F1699_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **1,699 / 1,699 passing (2,006 total incl. verification)** | 100% | 1,411 Backend Pytest + 257 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (1,699 Tests Core / 2,006 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (1,411 tests)
