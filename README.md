...
[![Passing Tests](https://img.shields.io/badge/tests-3143%2F3143_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
│   │
│   └── tests/                                       # Vitest & React Testing Library Suite (291 Tests across 81 Files)
│
...
| **Full Test Suite Pass Rate** | **2,836 / 2,836 passing (3,143 total incl. verification)** | 100% | 2,514 Backend Pytest + 291 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,836 Tests Core / 3,143 Total)
```bash
...
# 3. Run full frontend vitest suite (291 tests across 81 test files)
