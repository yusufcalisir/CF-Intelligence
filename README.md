...
[![Passing Tests](https://img.shields.io/badge/tests-3196%2F3196_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,889 / 2,889 passing (3,196 total incl. verification)** | 100% | 2,534 Backend Pytest + 324 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,889 Tests Core / 3,196 Total)
```bash
...
# 3. Run full frontend vitest suite (324 tests across 81 test files)
