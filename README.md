...
[![Passing Tests](https://img.shields.io/badge/tests-3125%2F3125_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
│   │
│   └── tests/                                       # Comprehensive Backend Test Suite (2,513 Tests)
...
│   │
│   └── tests/                                       # Vitest & React Testing Library Suite (270 Tests across 81 Files)
│
...
| **Full Test Suite Pass Rate** | **2,818 / 2,818 passing (3,125 total incl. verification)** | 100% | 2,513 Backend Pytest + 274 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,818 Tests Core / 3,125 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (2,513 tests)
pytest backend/tests/ -v

# 2. Run Interactive POC Sandbox Replay CLI evaluation
python benchmark.py --poc-replay

# 3. Run full frontend vitest suite (270 tests across 81 test files)
