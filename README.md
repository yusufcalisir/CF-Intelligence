...
[![Passing Tests](https://img.shields.io/badge/tests-2587%2F2587_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,274 / 2,274 passing (2,581 total incl. verification)** | 100% | 1,973 Backend Pytest + 268 Frontend Vitest + 33 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,274 Tests Core / 2,581 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (1,973 tests)
