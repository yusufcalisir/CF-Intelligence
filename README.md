...
[![Passing Tests](https://img.shields.io/badge/tests-3158%2F3158_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
│   │
│   └── tests/                                       # Vitest & React Testing Library Suite (306 Tests across 81 Files)
│
...
| **Full Test Suite Pass Rate** | **2,851 / 2,851 passing (3,158 total incl. verification)** | 100% | 2,514 Backend Pytest + 306 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
# 3. Run full frontend vitest suite (306 tests across 81 test files)
