...
[![Passing Tests](https://img.shields.io/badge/tests-1605%2F1605_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
│   │
│   └── tests/                                       # Comprehensive Backend Test Suite (1,335 Tests)
...
│   │
│   └── tests/                                       # Vitest & React Testing Library Suite (257 Tests across 79 Files)
│
...
| **Full Test Suite Pass Rate** | **1,605 / 1,605 passing (1,922 total incl. verification)** | 100% | 1,335 Backend Pytest + 257 Frontend Vitest + 13 Smart Contracts + 10 Playwright Real-Browser E2E Tests (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (1,526 Tests Core / 1,833 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (1,246 tests)
pytest backend/tests/ -v

# 2. Run full frontend vitest suite (257 tests across 79 test files)
