...
| **Full Test Suite Pass Rate** | **2,858 / 2,858 passing (3,165 total incl. verification)** | 100% | 2,514 Backend Pytest + 313 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
# 3. Run full frontend vitest suite (313 tests across 81 test files)
