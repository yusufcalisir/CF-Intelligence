...
[![Passing Tests](https://img.shields.io/badge/tests-3185%2F3185_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,878 / 2,878 passing (3,185 total incl. verification)** | 100% | 2,528 Backend Pytest + 319 Frontend Vitest + 31 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,878 Tests Core / 3,185 Total)
```bash
...
# 3. Run full frontend vitest suite (319 tests across 81 test files)
