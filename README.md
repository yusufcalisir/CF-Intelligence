...
[![Passing Tests](https://img.shields.io/badge/tests-2580%2F2580_passing-success.svg?style=flat&logo=pytest&logoColor=white)](https://github.com/yusufcalisir/CF-Intelligence/actions)
...
| **Full Test Suite Pass Rate** | **2,271 / 2,271 passing (2,580 total incl. verification)** | 100% | 1,970 Backend Pytest + 268 Frontend Vitest + 33 Smart Contracts (+ 307 Scientific Verification Tests) | `Self-Verified (Internal Test Suite)` |
...
### Step 5: Master Test Suites Execution (2,271 Tests Core / 2,580 Total)
```bash
# (Ensure commands are executed from the repository root directory)
# 1. Run full backend pytest suite (1,970 tests)
