...
from app.domain.value_objects_copilot import (
...
# Register endpoints across canonical and legacy routers
...
@router.post("/assemble-evidence")
def assemble_evidence_v1(payload: CopilotDirectGenerationRequest) -> dict[str, Any]:
    """Assemble cryptographic evidence package (v1 legacy prefix)."""
    return assemble_evidence_api_v1(payload)


@api_router.post("/assemble-evidence")
def assemble_evidence_api_v1(payload: CopilotDirectGenerationRequest) -> dict[str, Any]:
