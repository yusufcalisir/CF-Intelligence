...
const API_ENDPOINTS: ApiEndpointSpec[] = [
  ...
  {
    id: 'inject-attack',
    category: 'Chaos & Byzantine Defense',
    method: 'POST',
    path: '/api/v1/scenarios/inject-attack',
    title: 'Inject Adversarial Byzantine Attack & Evaluate Multi-Krum Shield',
    description:
      'Simulates live smurfing bursts (500 tx/s) or Byzantine gradient poisoning (Δw × -10.0) from compromised bank nodes. Evaluates defense shield, triggers node quarantine, and measures global AUC protection.',
    authRequired: true,
    ...
    requestBodySample: {
      scenario_id: 'scenario_smurfing_ring',
      attack_type: 'byzantine_gradient_poison',
      attacker_bank_id: 'bank_gamma',
      poison_scale: -10.0,
      burst_tx_per_sec: 500,
    },
    responseBodySample: {
      status: 'ATTACK_NEUTRALIZED',
      attack_type: 'byzantine_gradient_poison',
      attacker_bank_id: 'bank_gamma',
      shield_activated: 'Multi-Krum',
      euclidean_distance: 48.24,
      krum_threshold: 14.12,
      quarantine_status: 'QUARANTINED BY KRUM',
      auc_impact: {
        unprotected_auc: 0.46,
        protected_auc: 0.88,
        auc_delta: 0.42,
      },
      message: 'Byzantine vector isolated from global model aggregation.',
    },
  },
  {
    id: 'contract-audit',
    category: 'Dataset Ingestion & Quality',
    method: 'POST',
    path: '/api/v1/datasets/contract-audit',
    title: 'Audit Ingested Transactions via Great Expectations Data Contract',
    description:
      'Runs 12 automated statistical and schema contract rules against sanitized bank transaction records. Evaluates Non-IID Dirichlet alpha distribution, KS feature drift, and generates failed records quarantine.',
    authRequired: true,
    ...
    requestBodySample: {
      bank_id: 'bank_alpha',
      dataset_name: 'alpha_q3_transactions.parquet',
      row_count: 50000,
      zero_pii_token: '0x8f4343...aa4',
      strict_validation: true,
    },
    responseBodySample: {
      contract_name: 'BankTransactionConsortiumContract.v1',
      total_rules_evaluated: 12,
      rules_passed: 12,
      audit_status: 'PASSED_ZERO_DEFECTS',
      dirichlet_alpha: 0.524,
      kolmogorov_smirnov_drift: 0.024,
      quarantine_records_count: 0,
      certified_for_fl_enrollment: true,
    },
  },
  {
    id: 'consortium-enroll',
    category: 'Dataset Ingestion & Quality',
    method: 'POST',
    path: '/api/v1/datasets/consortium-enroll',
    title: 'Enroll Validated Partition into Federated Learning Round',
    description:
      'Enrolls an audited transaction partition into the active federated consortium bank partition pool and updates local DataLoader tensors for the upcoming training round.',
    authRequired: true,
    ...
    requestBodySample: {
      bank_id: 'bank_alpha',
      dataset_name: 'alpha_q3_transactions.parquet',
      partition_id: 'part_alpha_node_01',
      row_count: 50000,
    },
    responseBodySample: {
      status: 'ENROLLED',
      ...
      partition_id: 'part_alpha_node_01',
      assigned_round: 4,
      tensor_dimension: [50000, 9],
      message: 'Dataset enrolled successfully for federated training round.',
    },
  },
];
