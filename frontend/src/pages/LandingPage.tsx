  ...
  return (
    <div className="min-h-screen bg-[#05050f] text-slate-300 font-sans antialiased selection:bg-indigo-600 selection:text-white w-full max-w-full overflow-x-hidden min-w-0">
      ...
      <div className="relative z-10 w-full max-w-full min-w-0">
        ...
        ══════════════════════════════════════════════════════════ */}
        <section id="hero" className="relative py-4 sm:py-6 lg:py-8 px-3.5 sm:px-6 max-w-7xl mx-auto w-full min-w-0 min-h-[calc(100vh-64px)] flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-8 lg:gap-10 items-center min-w-0 w-full">

            {/* Left Hero Content */}
            <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.5}} className="lg:col-span-7 space-y-3.5 sm:space-y-4 lg:space-y-5 min-w-0">
              <div className="space-y-2 lg:space-y-3 min-w-0">
                <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-0.5 sm:py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[11px] sm:text-xs font-mono max-w-full truncate">
                  <span className="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse shrink-0" />
                  <span className="truncate">Privacy-Preserving Federated Infrastructure</span>
                </div>
                <h1 className="text-3xl sm:text-4xl lg:text-[44px] xl:text-[48px] font-extrabold tracking-tight leading-[1.12] break-words">
                ...
                <p className="text-slate-400 text-xs sm:text-sm lg:text-[15px] leading-relaxed max-w-xl font-sans">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 w-full min-w-0">
                <div className="p-2.5 sm:p-3 rounded-2xl bg-white/3 border border-white/8 backdrop-blur-xl min-w-0">
              ...
              {/* Action Buttons (Restored to bottom position below metric cards) */}
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full min-w-0 pt-1">
                <button
                  onClick={() => navigate('/dashboard')}
            ...
            <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.5,delay:0.1}} className="lg:col-span-5 w-full min-w-0">
