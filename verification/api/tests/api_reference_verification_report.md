...
| T04 | W3C Traceparent Header Propagation | Expected specification contract behavior | ✅ PASS | traceparent: 00-3dcf5066288746068e45839fae8af3de-aad5e67f91584dee-01 |
...
| T06 | POST /api/v1/predict Valid Payload | Expected specification contract behavior | ✅ PASS | Status 200, Probability: 0.5288417339324951 |
...
| T09 | POST /api/v1/predict Bounded Model Probability Invariant | Expected specification contract behavior | ✅ PASS | Score 1: 0.5287551283836365, Score 2: 0.5291645526885986 |
...
| T12 | POST /api/v1/cases Idempotency-Key Deduplication | Expected specification contract behavior | ✅ PASS | Case ID 1: 243e992c-c819-4436-a389-f835cbf25a23, Case ID 2: 243e992c-c819-4436-a389-f835cbf25a23 |
...
| T16 | Gateway RFC Rate Limit Functionality | Expected specification contract behavior | ✅ PASS | Limit: 120, Remaining: 119, Reset: 19s |
